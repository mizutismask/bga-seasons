...
class SeasonsSK extends Table {
    ...
    */
    ...
    function upgradeTableDb($from_version) {
        ...
        $changes = [
            [2208182316, "ALTER TABLE DBPREFIX_player ADD `player_score_cristals` int(10) NOT NULL DEFAULT '0'"],
            [2208182316, "ALTER TABLE DBPREFIX_player ADD `player_score_raw_cards` int(10) NOT NULL DEFAULT '0'"],
            [2208182316, "ALTER TABLE DBPREFIX_player ADD `player_score_eog_cards` int(10) NOT NULL DEFAULT '0'"],
            [2208182316, "ALTER TABLE DBPREFIX_player ADD `player_score_bonus_actions` int(10) NOT NULL DEFAULT '0'"],
            [2208182316, "ALTER TABLE DBPREFIX_player ADD `player_score_remaining_cards` int(10) NOT NULL DEFAULT '0'"],
            [2208182316, "ALTER TABLE DBPREFIX_player ADD `player_score_token` int(10) NOT NULL DEFAULT '0'"],
            [2208182316, "ALTER TABLE DBPREFIX_player ADD `player_last_draft_card` int(10)"],
            [2208182316, "ALTER TABLE DBPREFIX_player ADD `player_reset_possible` TINYINT(1) UNSIGNED NOT NULL DEFAULT  '0'"],
            [2208182316, "CREATE TABLE IF NOT EXISTS DBPREFIX_ability_token (
            ...
            [2208182316, "CREATE TABLE IF NOT EXISTS DBPREFIX_resource_undo (
            ...
            [2208182316, "CREATE TABLE IF NOT EXISTS DBPREFIX_resource_on_card_undo (
            ...
            [2208182316, "INSERT INTO DBPREFIX_global (`global_id`, `global_value`) VALUES (34, 0)"],
