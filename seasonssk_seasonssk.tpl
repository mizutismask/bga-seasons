...
<audio id="audiosrc_season_4" src="{GAMETHEMEURL}/img/season_4.mp3" autobuffer></audio>
...
<audio id="audiosrc_o_season_4" src="{GAMETHEMEURL}/img/season_4.ogg" autobuffer></audio>
